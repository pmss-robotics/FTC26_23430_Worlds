...
@Autonomous(name = "|B|18|N|", group = "Autonomous")
public class NewBlueAuto18 extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(128.000, 33.000, Math.toRadians(0)));
    }
    ...
    public void buildPaths() {
        ...
        Path4 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Pose(91.000, 68.000),
                                new Pose(111.000, 95.000),
                                new Pose(133.000, 82.500)
                        )
                )
        ...
        Path8 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Pose(91.000, 68.000),
                                new Pose(93.000, 60.000),
                                new Pose(122.000, 61.000)
                        )
                )
